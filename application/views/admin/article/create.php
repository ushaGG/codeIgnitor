          ...
          <div class="col-lg-12">
            <div class="card card-primary" >
              <div class="card-header ">
                ...
                <form action="<?php echo base_url().'index.php/admin/category/create' ?>" method="post" name="categoryForm" id="categoryForm">
                
                  <div class="card-body">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" id="name" value="<?php set_value('name')?>" class="form-control" <?php echo (form_error('name') != "" ) ? 'is-invalid':''; ?> />
                      ...
                      <div class="custom-control custom-radio float-left ml-3">
                          <input class="custom-control-input" value="1" type="radio" id="block" name="status">
